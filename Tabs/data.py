    ...
    st.markdown(
        """
            <p style="font-size:25px">
                The following are the results of <b style="color:green">analysis done on the available heart disease dataset.</b> Each graph shows the result based on different attributes.</b> 
            </p>
